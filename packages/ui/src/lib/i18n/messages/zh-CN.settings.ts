...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.keyboardShortcuts.search.placeholder': '搜索快捷键',
  'settings.openchamber.keyboardShortcuts.search.aria': '搜索快捷键',
  'settings.openchamber.keyboardShortcuts.search.clear': '清除搜索',
  'settings.openchamber.keyboardShortcuts.search.byShortcut': '按快捷键搜索',
  'settings.openchamber.keyboardShortcuts.search.dialog.title': '按快捷键搜索',
  'settings.openchamber.keyboardShortcuts.search.dialog.instructions': '按下按键组合并确认，即可只显示使用该组合的快捷键。',
  'settings.openchamber.keyboardShortcuts.search.filterLabel': '正在显示 {shortcut}',
  'settings.openchamber.keyboardShortcuts.search.resetFilter': '清除快捷键筛选',
  'settings.openchamber.keyboardShortcuts.search.noResults': '没有匹配的快捷键。',
  'settings.openchamber.keyboardShortcuts.search.noShortcutResults': '没有快捷键使用此组合。',
