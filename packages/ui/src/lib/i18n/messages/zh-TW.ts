...
export const dict: Record<I18nKey, string> = {
  ...
  'updateDialog.localChanges.title': '本機變更',
  ...
  'commandcodeModelsUpdate.toast.title': '模型清單已更新',
  'commandcodeModelsUpdate.toast.restarting': '正在重新啟動 OpenChamber...',
  'commandcodeModelsUpdate.toast.restartFailed': '無法重新啟動 OpenChamber',
  'commandcodeModelsUpdate.toast.dismissFailed': '無法忽略此更新',
  'commandcodeModelsUpdate.toast.actions.view': '檢視',
  'commandcodeModelsUpdate.toast.actions.restart': '重新啟動',
  'commandcodeModelsUpdate.toast.actions.dismiss': '忽略',
  'commandcodeModelsUpdate.dialog.title': '模型清單已更新',
  'commandcodeModelsUpdate.dialog.description': 'Command Code 變更了可用模型。重新啟動 OpenChamber 以載入新的清單。',
  'commandcodeModelsUpdate.dialog.actions.restart': '重新啟動 OpenChamber',
  'commandcodeModelsUpdate.dialog.actions.restarting': '正在重新啟動...',
  'commandcodeModelsUpdate.dialog.actions.close': '關閉',
