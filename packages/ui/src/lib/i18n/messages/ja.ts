...
export const dict: Record<I18nKey, string> = {
  ...
  'updateDialog.actions.update': '更新',
  'updateDialog.localChanges.title': 'ローカルの変更',
  ...
  'commandcodeModelsUpdate.toast.title': 'モデルリストを更新しました',
  'commandcodeModelsUpdate.toast.restarting': 'OpenChamber を再起動しています...',
  'commandcodeModelsUpdate.toast.restartFailed': 'OpenChamber を再起動できませんでした',
  'commandcodeModelsUpdate.toast.dismissFailed': '更新を閉じられませんでした',
  'commandcodeModelsUpdate.toast.actions.view': '表示',
  'commandcodeModelsUpdate.toast.actions.restart': '再起動',
  'commandcodeModelsUpdate.toast.actions.dismiss': '閉じる',
  'commandcodeModelsUpdate.dialog.title': 'モデルリストを更新しました',
  'commandcodeModelsUpdate.dialog.description': 'Command Code の利用可能なモデルが変更されました。新しいリストを読み込むには OpenChamber を再起動してください。',
  'commandcodeModelsUpdate.dialog.actions.restart': 'OpenChamber を再起動',
  'commandcodeModelsUpdate.dialog.actions.restarting': '再起動中...',
  'commandcodeModelsUpdate.dialog.actions.close': '閉じる',
