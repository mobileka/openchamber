...
export const settingsDict = {
  ...
  'settings.openchamber.keyboardShortcuts.search.placeholder': 'Szukaj skrótów',
  'settings.openchamber.keyboardShortcuts.search.aria': 'Szukaj skrótów',
  'settings.openchamber.keyboardShortcuts.search.clear': 'Wyczyść wyszukiwanie',
  'settings.openchamber.keyboardShortcuts.search.byShortcut': 'Szukaj po skrócie',
  'settings.openchamber.keyboardShortcuts.search.dialog.title': 'Szukaj po skrócie',
  'settings.openchamber.keyboardShortcuts.search.dialog.instructions': 'Naciśnij kombinację klawiszy i potwierdź, aby pokazać tylko skróty, które jej używają.',
  'settings.openchamber.keyboardShortcuts.search.filterLabel': 'Pokazywanie: {shortcut}',
  'settings.openchamber.keyboardShortcuts.search.resetFilter': 'Wyczyść filtr skrótu',
  'settings.openchamber.keyboardShortcuts.search.noResults': 'Żadne skróty nie pasują do wyszukiwania.',
  'settings.openchamber.keyboardShortcuts.search.noShortcutResults': 'Żadne skróty nie używają tej kombinacji.',
