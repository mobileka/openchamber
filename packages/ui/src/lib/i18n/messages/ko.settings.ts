...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.keyboardShortcuts.search.placeholder': '단축키 검색',
  'settings.openchamber.keyboardShortcuts.search.aria': '단축키 검색',
  'settings.openchamber.keyboardShortcuts.search.clear': '검색 지우기',
  'settings.openchamber.keyboardShortcuts.search.byShortcut': '단축키로 검색',
  'settings.openchamber.keyboardShortcuts.search.dialog.title': '단축키로 검색',
  'settings.openchamber.keyboardShortcuts.search.dialog.instructions': '키 조합을 누른 뒤 확인하면 해당 조합을 사용하는 단축키만 표시됩니다.',
  'settings.openchamber.keyboardShortcuts.search.filterLabel': '{shortcut} 표시 중',
  'settings.openchamber.keyboardShortcuts.search.resetFilter': '단축키 필터 지우기',
  'settings.openchamber.keyboardShortcuts.search.noResults': '검색과 일치하는 단축키가 없습니다.',
  'settings.openchamber.keyboardShortcuts.search.noShortcutResults': '이 조합을 사용하는 단축키가 없습니다.',
