...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.keyboardShortcuts.search.placeholder': '搜尋快速鍵',
  'settings.openchamber.keyboardShortcuts.search.aria': '搜尋快速鍵',
  'settings.openchamber.keyboardShortcuts.search.clear': '清除搜尋',
  'settings.openchamber.keyboardShortcuts.search.byShortcut': '依快速鍵搜尋',
  'settings.openchamber.keyboardShortcuts.search.dialog.title': '依快速鍵搜尋',
  'settings.openchamber.keyboardShortcuts.search.dialog.instructions': '按下按鍵組合並確認，即可只顯示使用該組合的快速鍵。',
  'settings.openchamber.keyboardShortcuts.search.filterLabel': '正在顯示 {shortcut}',
  'settings.openchamber.keyboardShortcuts.search.resetFilter': '清除快速鍵篩選',
  'settings.openchamber.keyboardShortcuts.search.noResults': '沒有符合搜尋的快速鍵。',
  'settings.openchamber.keyboardShortcuts.search.noShortcutResults': '沒有快速鍵使用此組合。',
