...
export const settingsDict = {
  ...
  'settings.openchamber.keyboardShortcuts.search.placeholder': 'Search shortcuts',
  'settings.openchamber.keyboardShortcuts.search.aria': 'Search shortcuts',
  'settings.openchamber.keyboardShortcuts.search.clear': 'Clear search',
  'settings.openchamber.keyboardShortcuts.search.byShortcut': 'Search by shortcut',
  'settings.openchamber.keyboardShortcuts.search.dialog.title': 'Search by shortcut',
  'settings.openchamber.keyboardShortcuts.search.dialog.instructions': 'Press a key combination, then confirm to show only the shortcuts using it.',
  'settings.openchamber.keyboardShortcuts.search.filterLabel': 'Showing {shortcut}',
  'settings.openchamber.keyboardShortcuts.search.resetFilter': 'Clear shortcut filter',
  'settings.openchamber.keyboardShortcuts.search.noResults': 'No shortcuts match your search.',
  'settings.openchamber.keyboardShortcuts.search.noShortcutResults': 'No shortcuts use this combination.',
