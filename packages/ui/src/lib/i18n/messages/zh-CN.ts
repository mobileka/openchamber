...
export const dict: Record<I18nKey, string> = {
  ...
  'updateDialog.localChanges.title': '本地更改',
  ...
  'commandcodeModelsUpdate.toast.title': '模型列表已更新',
  'commandcodeModelsUpdate.toast.restarting': '正在重启 OpenChamber...',
  'commandcodeModelsUpdate.toast.restartFailed': '无法重启 OpenChamber',
  'commandcodeModelsUpdate.toast.dismissFailed': '无法忽略此更新',
  'commandcodeModelsUpdate.toast.actions.view': '查看',
  'commandcodeModelsUpdate.toast.actions.restart': '重启',
  'commandcodeModelsUpdate.toast.actions.dismiss': '忽略',
  'commandcodeModelsUpdate.dialog.title': '模型列表已更新',
  'commandcodeModelsUpdate.dialog.description': 'Command Code 更改了可用模型。重启 OpenChamber 以加载新列表。',
  'commandcodeModelsUpdate.dialog.actions.restart': '重启 OpenChamber',
  'commandcodeModelsUpdate.dialog.actions.restarting': '正在重启...',
  'commandcodeModelsUpdate.dialog.actions.close': '关闭',
