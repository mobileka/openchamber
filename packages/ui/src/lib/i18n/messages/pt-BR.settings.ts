...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.keyboardShortcuts.search.placeholder": "Pesquisar atalhos",
  "settings.openchamber.keyboardShortcuts.search.aria": "Pesquisar atalhos",
  "settings.openchamber.keyboardShortcuts.search.clear": "Limpar pesquisa",
  "settings.openchamber.keyboardShortcuts.search.byShortcut": "Pesquisar por atalho",
  "settings.openchamber.keyboardShortcuts.search.dialog.title": "Pesquisar por atalho",
  "settings.openchamber.keyboardShortcuts.search.dialog.instructions": "Pressione uma combinação de teclas e confirme para mostrar apenas os atalhos que a usam.",
  "settings.openchamber.keyboardShortcuts.search.filterLabel": "Mostrando {shortcut}",
  "settings.openchamber.keyboardShortcuts.search.resetFilter": "Limpar filtro de atalho",
  "settings.openchamber.keyboardShortcuts.search.noResults": "Nenhum atalho corresponde à sua pesquisa.",
  "settings.openchamber.keyboardShortcuts.search.noShortcutResults": "Nenhum atalho usa esta combinação.",
