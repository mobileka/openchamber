...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.keyboardShortcuts.search.placeholder": "Пошук комбінацій",
  "settings.openchamber.keyboardShortcuts.search.aria": "Пошук комбінацій",
  "settings.openchamber.keyboardShortcuts.search.clear": "Очистити пошук",
  "settings.openchamber.keyboardShortcuts.search.byShortcut": "Пошук за комбінацією",
  "settings.openchamber.keyboardShortcuts.search.dialog.title": "Пошук за комбінацією",
  "settings.openchamber.keyboardShortcuts.search.dialog.instructions": "Натисніть комбінацію клавіш і підтвердьте, щоб показати лише комбінації, які її використовують.",
  "settings.openchamber.keyboardShortcuts.search.filterLabel": "Показано {shortcut}",
  "settings.openchamber.keyboardShortcuts.search.resetFilter": "Очистити фільтр комбінацій",
  "settings.openchamber.keyboardShortcuts.search.noResults": "Немає комбінацій за вашим пошуком.",
  "settings.openchamber.keyboardShortcuts.search.noShortcutResults": "Немає комбінацій із таким поєднанням клавіш.",
