...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.keyboardShortcuts.search.placeholder": "Buscar atajos",
  "settings.openchamber.keyboardShortcuts.search.aria": "Buscar atajos",
  "settings.openchamber.keyboardShortcuts.search.clear": "Borrar búsqueda",
  "settings.openchamber.keyboardShortcuts.search.byShortcut": "Buscar por atajo",
  "settings.openchamber.keyboardShortcuts.search.dialog.title": "Buscar por atajo",
  "settings.openchamber.keyboardShortcuts.search.dialog.instructions": "Pulsa una combinación de teclas y confirma para mostrar solo los atajos que la usan.",
  "settings.openchamber.keyboardShortcuts.search.filterLabel": "Mostrando {shortcut}",
  "settings.openchamber.keyboardShortcuts.search.resetFilter": "Borrar filtro de atajos",
  "settings.openchamber.keyboardShortcuts.search.noResults": "Ningún atajo coincide con tu búsqueda.",
  "settings.openchamber.keyboardShortcuts.search.noShortcutResults": "Ningún atajo usa esta combinación.",
