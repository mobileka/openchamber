...
'settings.remoteInstances.clientAuth.actions.addDevice': 'デバイスを追加',
  ...
  'settings.openchamber.keyboardShortcuts.search.placeholder': 'ショートカットを検索',
  'settings.openchamber.keyboardShortcuts.search.aria': 'ショートカットを検索',
  'settings.openchamber.keyboardShortcuts.search.clear': '検索をクリア',
  'settings.openchamber.keyboardShortcuts.search.byShortcut': 'ショートカットで検索',
  'settings.openchamber.keyboardShortcuts.search.dialog.title': 'ショートカットで検索',
  'settings.openchamber.keyboardShortcuts.search.dialog.instructions': 'キーの組み合わせを押してから確定すると、それを使用するショートカットだけを表示します。',
  'settings.openchamber.keyboardShortcuts.search.filterLabel': '{shortcut} を表示中',
  'settings.openchamber.keyboardShortcuts.search.resetFilter': 'ショートカットフィルターをクリア',
  'settings.openchamber.keyboardShortcuts.search.noResults': '検索に一致するショートカットはありません。',
  'settings.openchamber.keyboardShortcuts.search.noShortcutResults': 'この組み合わせを使用するショートカットはありません。',
